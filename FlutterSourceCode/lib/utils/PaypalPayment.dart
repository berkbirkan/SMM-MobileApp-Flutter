...
class PaypalPayment extends StatefulWidget {
  ...
  final String price,productname;

  PaypalPayment({this.onFinish,this.price,this.productname});

  @override
  State<StatefulWidget> createState() {
    return PaypalPaymentState(price: price,productname: productname);
  }
}
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  PaypalPaymentState({this.price,this.productname});
  ...
  String returnURL = stripesuccessurl;
  String cancelURL= stripefailurl;
